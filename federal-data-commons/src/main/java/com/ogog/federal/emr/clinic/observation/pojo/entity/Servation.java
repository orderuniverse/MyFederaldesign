 ...
 */
@Data
@TableName("obs_servation")
public class Servation extends BaseEntity {
	private static final long serialVersionUID = -4911532192609482804L;
	@TableId
	...
	@TableField(value = "codType")
	private String codType;                         // 病程记录类别
	@TableField(value = "codCont")
	private String codCont;                         // 病程记录内容
	@TableField(value = "cureCode")
	private String cureCode;                        // 治疗类别代码
